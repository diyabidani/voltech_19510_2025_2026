...
@Autonomous(name = "Blue Wall", group = "Autonomous")
@Configurable // Panels
        ...
        public Paths(Follower follower) {
            Path1 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    ...
                                    new Pose(57.435, 96.603),
                                    new Pose(37.239, 105.943)
                            )
            ...
            Path2 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(37.239, 105.943),
                                    new Pose(65.694, 78.297),
                                    new Pose(17.560, 84.249)
                            )
            ...
            Path3 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(17.560, 84.249),
                                    new Pose(49.823, 93.077),
                                    new Pose(37.045, 105.829)
                            )
            ...
            Path4 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(37.045, 105.829),
                                    new Pose(72.799, 57.889),
                                    new Pose(17.938, 60.000)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(145), Math.toRadians(180))
            ...
            Path5 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(17.938, 60.000),
                                    new Pose(58.603, 91.391),
                                    new Pose(37.338, 105.997)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(145))
            ...
            Path6 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(37.338, 105.997),
                                    new Pose(81.093, 26.316),
                                    new Pose(37.564, 36.235),
                                    new Pose(17.966, 35.314)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(145), Math.toRadians(180))
            ...
            Path7 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(17.966, 35.314),
                                    new Pose(62.545, 83.926),
                                    new Pose(37.371, 105.977)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(145))
